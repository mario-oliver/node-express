...
app.get('/', (req, res) => {
  ...
  /**
   * there are two other methods rather than using sendFile:
   * 1) since our index.html is also static, we could simply add it to the static(./public) folder
   * 2) we can use templates via SSR
   */
